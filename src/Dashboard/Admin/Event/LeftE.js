...
export default function LeftE(props) {
  const display = () => {
        ...
        <>
          ...
          <div className="text-white xl:block hidden absolute px-1 top-[50%]">
            ...
            <p className="my-5 max-w-[30rem]">
              ...
              conçernant les évènements . Assurez-vous de remplir tout
              les champs.
            </p>
            <Link
      ...
      return (
        <>
          ...
          <div className="text-white xl:block hidden absolute px-1 top-[50%]">
            ...
            <p className="my-5 max-w-[30rem]">
              {" "}
              Bienvenu, ajouter un évènement selon le choix de l'association.
              Assurez-vous de remplir tout les champs.
            </p>
            <Link
              to="/dashboard/admin/events"
              className="ring-2 mt-5 ring-white font-bold hover:ring-cyan-300 px-4 text-xl py-2 uppercase rounded-full"
